...
const data = [
  {
    ...
    description: `<a href="https://lookuptax.com/docs/country/uk-vat-guidelines-sales-tax-indirect-tax-united-kingdom" target="_blank" rel="noopener noreferrer"> UK </a> Europe. Australia. No matter the country, call our API's and instantly see the results. You don't deserve to wait.`,
  },
  {
    id: 2,
    icon: Free,
